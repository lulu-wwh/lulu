<template>
  <div>
    ...
    <el-card style="margin-bottom: 20px" class="mt">
      <el-row :gutter="16">
        <el-col :span="6">
  ...
  methods: {
    ...
    //   }
      ...
      this.tableData = this.originData.filter((item) => {
        //     return (
        //       item.name ==(this.searchValue.name == "" ? item.name : this.searchValue.name) &&
        //       item.education ==
        ...
        return (item.name ==(this.searchValue.name ? this.searchValue.name : item.name) &&
          item.education == (this.searchValue.eduction? this.searchValue.education : item.education) &&
          item.mobile ==(this.searchValue.mobile ? this.searchValue.mobile : item.mobile)
        );
      });
    },
